  ...
  render()
  {
    return(
       <div className="opaque">
        ...
        <h1><strong>Age of </strong><strong className="red-one">{this.state.characters[0].name.indexOf("(") == -1 ? this.state.characters[0].name : this.state.characters[0].name.substr(0,this.state.characters[0].name.indexOf("(")-1)}</strong><strong>!</strong></h1>
